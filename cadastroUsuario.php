...
<body>
    ...
    <div class="input-group">
        ...
        <input type="text" name="login" placeholder="Nome de usuário" required autofocus><br><br>
        </div>
        ...
        <div class="input-group">
        <button  class="btn2" type="submit">Criar conta</button>
        </div>
        <div class="input-group">
        <button  class="btn" type="submit">Página Incial</button>
        </div>
    </form>
</body>
